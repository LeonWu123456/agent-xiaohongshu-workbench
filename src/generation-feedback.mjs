...
export function generationFailureFeedback(error) {
  ...
  if (/TEXT_QUALITY_GATE_FAILED.*body:length|body:length/i.test(message)) return { ...meta, stage: "text", code: "COPY_LENGTH_REJECTED", title: "系统还没把正文修到合适长度", detail: "旧稿已保留。点“重试文字”后，系统会继续只修正文，不需要改原文，也不会生成图片。" };
